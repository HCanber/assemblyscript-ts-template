// Minimal definitions for portable AssemblyScript. 
// Only types and functions for type conversions are kept, no functions.
// If the full portable definitions are needed, use the following instead:
//   import "assemblyscript/std/portable";
// Comments have been inserted to "remove" the unused parts.
// Copied from: https://github.com/AssemblyScript/assemblyscript/blob/6a7aaefc93ef8b755658dfea003b4e6a45614bf4/std/portable/index.d.ts
//------------------------------------------------------------------------------
